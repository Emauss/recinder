      ...
      <div className="row recipeBlock p-3">
        <div className="col-12 col-lg-8 mb-3">
          ...
          <div className="row shortInfoBar align-items-end justify-content-end mb-3">
            <div className="col">
              <span className="col-12 col-md-4">Time: {recipe.readyInMinutes}'</span>
              <span className="col-12 col-md-4">Price: {(recipe.pricePerServing / 100).toFixed(2)}$ per serving</span>
              <span className="col-12 col-md-4">Servings: {recipe.servings}</span>
            </div>
          </div>
        </div>
